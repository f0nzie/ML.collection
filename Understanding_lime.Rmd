...
Text explanations are also available through `shiny` to explore interactively the model.
...
![Interactive text explanations](shine_text_explanations.gif){width=700px}
