...
gt <- read_delim("multiTimeline.csv", delim = ",") %>% 
  rename(predictive_maintenance = "Predictive maintenance") %>% 
  rename(week = Week)
...
```{r}
renderGauge({
  gauge(round(as.numeric(test_performance[num(), "pred"]) * 100, digits = 2), 
...
```{r}
renderValueBox({
valueBox(round(accuracy, digits = 3), icon = "fa-check", 
         caption = "Accuracy of ML model on test set", color = "danger")
})
```
...
```{r}
renderValueBox({
valueBox(round(misclassification_rate, digits = 3), icon = "fa-check-circle", 
         caption = "Misclassification rate", color = "primary")
})
```
...
```{r}
renderValueBox({
valueBox(round(recall, digits = 3), icon = "fa-check-circle-o", 
         caption = "Recall", color = "primary")
})
```
...
```{r}
renderValueBox({
valueBox(round(precision, digits = 3), icon = "fa-check-square", 
         caption = "Precision", color = "primary")
})
```
...
```{r}
renderValueBox({
valueBox(round(null_error_rate, digits = 3), icon = "fa-check-square-o", 
         caption = "Null Error Rate", color = "primary")
})
```
